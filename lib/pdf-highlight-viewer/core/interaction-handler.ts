...
export class UnifiedInteractionHandler {
  ...
  private startTextSelection(event: MouseEvent): void {
    document.body.style.userSelect = 'text';
    this.selectionState.isSelecting = true;
  }

  private startAutoDetection(event: MouseEvent): void {
  }
  ...
  private finishTextSelection(event: MouseEvent): void {
    this.processTextSelection();
  ...
  private isDoubleClick(event: MouseEvent): boolean {
